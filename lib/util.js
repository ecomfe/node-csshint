...
exports.addInvalid = function (params) {
    console.log(params.lineMessage);
    console.log(params.markMessage);
    console.log(params.infoMessage);
    console.log(params.normalMsg);
}
